...
export const emitters = [
  { truck: 1, x: 317, y: 102, dx: -35, dy: -39 },
  { truck: 4, x: 679, y: 573, dx: -30, dy: -43 },
];
...
export function smokeMarkup(seconds) {
  return smokeAt(seconds).map(puff => `<g data-truck="${puff.truck}" opacity="${puff.opacity.toFixed(4)}" transform="translate(${puff.x.toFixed(3)} ${puff.y.toFixed(3)}) scale(${puff.radius.toFixed(3)})"><path d="M-1 .1C-1.25-.35-.8-.8-.43-.71C-.32-1.15 .38-1.13 .59-.63C1.12-.74 1.38-.14 1.04 .18C1.27 .64 .57 .95 .22 .65C-.19 1.02-.9 .72-1 .1Z" fill="#465767" stroke="#384d62" stroke-width=".065"/><path d="M-.83-.14C-.85-.49-.49-.67-.2-.52C.04-.82 .49-.73 .56-.4" fill="none" stroke="#bfccd3" stroke-width=".17" stroke-linecap="round"/></g>`).join('');
}
